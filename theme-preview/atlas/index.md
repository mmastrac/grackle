...
date: 2026-07-20
---
The wide one: a sticky section tree on the left, a sticky page outline on
the right, and listings that arrive as card grids or masonry instead of a
stack of summaries. Both rails are optional parts, so a page without them
simply centres.

## What to look at

- **[Notes](view:atlas_notes_index)** — the listing face: summaries,
...
- **[Shelf](view:atlas_shelf_index)** — the card face, with a featured
  item.
- **[Wall](view:atlas_wall)** — the gallery face: masonry over objects.
