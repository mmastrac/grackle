...
date: 2026-07-20
---
Monospace, dark by default, nothing rounded. Structurally this is the same
single column as ledger — the difference is almost entirely the token block,
which is the gallery's whole claim under test.

## What to look at

- **[Notes](view:terminal_notes_index)** — the listing face: summaries,
...
- **[Shelf](view:terminal_shelf_index)** — the card face, with a featured
  item.
- **[Wall](view:terminal_wall)** — the gallery face: masonry over objects.
